...
subtitulo2.config(bg="ivory2", fg="black", font=("Times New Roman", 15), anchor=CENTER)
...
t_resultado.config(bg="black", fg="white", font=("Arial", 18))
